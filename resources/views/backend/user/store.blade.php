                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="user_catalogue_id" class="control-lable text-left">Nhóm thành viên
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="birthday" class="control-lable text-left">Ngày sinh</label>
                        ...
                        @if ($config['method'] == 'create')
                            <div class="row mb15">
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        <label for="password" class="control-lable text-left">Mật khẩu
                                            <span class="text-danger">(*)</span></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        <label for="re_password" class="control-lable text-left">Nhập lại mật khẩu
                                            <span class="text-danger">(*)</span></label>
                        ...
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="image" class="control-lable text-left">Ảnh đại diện
                                    </label>
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="province_id" class="control-lable text-left">Thành phố</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="district_id" class="control-lable text-left">Quận/Huyện</label>
                        ...
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="ward_id" class="control-lable text-left">Phường/Xã</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="address" class="control-lable text-left">Địa chỉ</label>
                        ...
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="phone" class="control-lable text-left">Số điện thoại</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="description" class="control-lable text-left">Ghi chú</label>
